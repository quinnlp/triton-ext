...
#define DEBUG_TYPE "triton-intel-ext-remove-boundary-checks"

using namespace mlir;
namespace tt = mlir::triton;

namespace mlir::triton::intel {
#define GEN_PASS_DEF_TRITONINTELEXTREMOVEBOUNDARYCHECKS
...
struct RemoveBoundaryChecksPass
    : tt::intel::impl::TritonIntelExtRemoveBoundaryChecksBase<
          RemoveBoundaryChecksPass> {
public:
